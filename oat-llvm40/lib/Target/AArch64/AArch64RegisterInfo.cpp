...
static cl::opt<bool> EnableAArch64ReserveSecureRegister("aarch64-enable-rsr",
                                cl::desc("Enable reserving secure register for control flow verification"),
...
AArch64RegisterInfo::getReservedRegs(const MachineFunction &MF) const {
  ...
  if (EnableAArch64ReserveSecureRegister) {
    markSuperRegs(Reserved, AArch64::X15); // Secure Register for control flow verification 
...
bool AArch64RegisterInfo::isReservedReg(const MachineFunction &MF,
  ...
  case AArch64::X15:
  case AArch64::W15:
    return EnableAArch64ReserveSecureRegister;
  case AArch64::FP:
  case AArch64::W29:
