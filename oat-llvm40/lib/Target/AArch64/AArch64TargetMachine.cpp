...
static cl::opt<bool>
    ControlFlowVerification("aarch64-enable-cfv", cl::Hidden, cl::init(true),
                     cl::desc("Instrument indirect call/jmp and ret instructions to verify control flow"));
...
extern "C" void LLVMInitializeAArch64Target() {
  ...
  initializeAArch64ControlFlowVerificationPass(*PR);
...
void AArch64PassConfig::addPreEmitPass() {
  ...
  if (ControlFlowVerification)
    addPass(createAArch64ControlFlowVerificationPass());
